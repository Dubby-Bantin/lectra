...
const Benefits = () => {
  const benefits = [
    ...
    "Reliable Scheduling and Email Notifications: Never miss a class or deadline! Lectra’s scheduling and email notification system keeps you informed and organized, making it easier to focus on learning.",
  ];
