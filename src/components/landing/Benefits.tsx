...
const Skeleton = ({ title }: { title: string }) => (
  <div className="flex flex-1 bg-gradient-to-r from-neutral-200 dark:from-[#0C0E23] to-neutral-100 dark:to-[#050112] -mr-2 p-2 rounded-xl w-full h-full min-h-[6rem] font-poppins text-lg text-white hover:text-gray-400">
    {title}
  </div>
);
const Benefits = () => {
