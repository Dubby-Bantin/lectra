...
const InstructorProfileSetUp = async ({
  ...
  const {
    ...
    idVerificationUrl,
  } = await getFireStoreRefData(params.id, "instructors");
          ...
          <div className="grid gap-3">
            <div className="">
              ...
              <p className="text-muted-foreground">
                ...
                Aperiam repudiandae nulla in, officiis ut possimus earum facere
                aliquid laboriosam! Doloremque quas atque eius id omnis
                blanditiis vero, mollitia veniam libero?
              </p>
            </div>
            <div className="">
